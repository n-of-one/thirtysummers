...
**Resources come back at different rates.** Everything in the inner ring,
inside the first stream, is back every summer: fruit, feathers, sticks where
saplings stand, vines in the mud. That is the safe option, and it means there
is always enough within reach to pay the upkeep. Things that only sell for
gold, ore and shells beyond the first stream, come back slowly, a share each
winter. A field worked hard one year gives less the next, and the family is
driven outward to find the next one. It never gives so little that play is
blocked.
...
3. **The shop.** What the town sells, with prices: tools, gear, and the
   ...
   Greyed when unaffordable. The price of what cannot be bought yet is what
   next summer aims at.
4. **The family.** Gold does not carry across winters. Whatever is left goes
   ...
   than the last, accumulated over the summers. A level does nothing yet.
   Later it may unlock tools. It never raises upkeep. It gives the surplus a
   meaning, and it is what the map arc calls family strength.
...
summer is, and what winter will need. What grew back and what wore is met on
the map.
