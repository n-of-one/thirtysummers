...
it gets home. The numbers and the barrier set for the first five summers are
in [../current/five-summers.md](../current/five-summers.md).

## The shape

A summer is a clock. It runs from a clean slate at camp, both bars full, to
a hard stop wherever the character stands. Its length follows age: about
five minutes at 15, fifteen at the physical peak from summer 10 to 20, back
...
Rock is the border of the map and nothing crosses it. Later barriers need
the tools the structures make: the mine's metal is for tools that break
what no knife or axe can.
